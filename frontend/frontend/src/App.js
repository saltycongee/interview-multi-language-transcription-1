                  ...
                  >
                    <Table.Header >
                      <Table.Row textAlign="center">
                        ...
                        <Popup
                            content="Transcription jobs usually take half the length of the audio file uploaded to complete"
                            position = {'top center'}
                            size = {'mini'}
                            trigger={<Table.HeaderCell>Transcription
                        
                              </Table.HeaderCell>}
                          />

                          <Popup
                          content="Translation jobs usually take 10-20 minutes to complete"
                          position = {'top center'}
                          size = {'mini'}
                          trigger={<Table.HeaderCell>Translation
