                                        ...
                                        <Grid.Row>
                                            <Grid.Column width={7} textAlign={"center"} verticalAlign={"middle"}>
                                                <div className={"brand-wrapper"}>
                                                    <span className={"brand-text"}>App<span className={"brand-text-divider"}>/</span>Name</span>
                                                </div>
                                            </Grid.Column>
                                            <Grid.Column width={9} textAlign={"center"} verticalAlign={"middle"}>
                                                <img style={{width: "100%", height: "100%"}} src={process.env.PUBLIC_URL + './Assets/Images/cic_logo_2020_inverse.png'} alt="..."/>
                                            </Grid.Column>
                                        </Grid.Row>
                                    </Grid>
                            </Grid.Column>
